...
import { updateFcmToken, getNotifications, markAsRead, markAllAsRead, deleteNotification, deleteAllNotifications } from "../controllers/notificationController.js";
...
//update email
router.put("/update-email", protectAppUser, updateEmail);
