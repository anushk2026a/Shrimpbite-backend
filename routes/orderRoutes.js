...
import { placeOrder, getMyOrders, placeSpotOrder, getUserOrderHistory, getOrderTracking, verifyPayment } from "../controllers/orderController.js";
import { protect } from "../middleware/authMiddleware.js";

const router = express.Router();

router.post("/", protectAppUser, placeOrder);
router.post("/verify-payment", protectAppUser, verifyPayment);
